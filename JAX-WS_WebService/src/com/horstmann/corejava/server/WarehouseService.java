 ...
 * 
 */
@WebServiceClient(name = "WarehouseService", targetNamespace = "http://corejava.horstmann.com/", wsdlLocation = "http://localhost:8080/WebServices/warehouse?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WAREHOUSESERVICE_QNAME = new QName("http://corejava.horstmann.com/", "WarehouseService");
    ...
    public Warehouse getWarehousePort() {
        return super.getPort(new QName("http://corejava.horstmann.com/", "WarehousePort"), Warehouse.class);
    }
    ...
    public Warehouse getWarehousePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://corejava.horstmann.com/", "WarehousePort"), Warehouse.class, features);
    }
