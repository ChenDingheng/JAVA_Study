...
class TestDB
{
    ...
    public static void runTest() throws SQLException, IOException
    {
        ...
        try
        {
            ...
            //stat.executeUpdate("INSERT INTO Greetings VALUES ('Im chen dingheng.')");
    ...
    public static Connection getConnection() throws SQLException, IOException
    {
        ...
        FileInputStream in = new FileInputStream("E:/Intellij_IDEA_Java_Workspace/Test/src/database.properties");
        props.load(in);
        in.close();
